...
**Backup Date:** 8/1/2026, 1:24:02 pm
**Backup Timestamp:** 2026-01-08T07-53-56
...
unzip backup-2026-01-08T07-53-56.zip

# Navigate to backup directory
cd backup-2026-01-08T07-53-56/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2026-01-08T07-53-56/database
```
