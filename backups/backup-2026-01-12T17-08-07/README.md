...
**Backup Date:** 12/1/2026, 10:38:22 pm
**Backup Timestamp:** 2026-01-12T17-08-07
...
unzip backup-2026-01-12T17-08-07.zip

# Navigate to backup directory
cd backup-2026-01-12T17-08-07/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2026-01-12T17-08-07/database
```
