...
**Backup Date:** 6/1/2026, 2:43:45 pm
**Backup Timestamp:** 2026-01-06T09-13-37
...
unzip backup-2026-01-06T09-13-37.zip

# Navigate to backup directory
cd backup-2026-01-06T09-13-37/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2026-01-06T09-13-37/database
```
