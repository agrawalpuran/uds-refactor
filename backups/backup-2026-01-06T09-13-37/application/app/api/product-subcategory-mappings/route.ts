  ...
  try {
    ...
    return NextResponse.json({
      ...
      mappings: mappings.map(mapping => {
        ...
        const productId = (mapping.productId as any)?.id || 
                         ((mapping.productId as any)?._id?.toString())
        const subCategoryId = (mapping.subCategoryId as any)?.id || 
                             ((mapping.subCategoryId as any)?._id?.toString())
