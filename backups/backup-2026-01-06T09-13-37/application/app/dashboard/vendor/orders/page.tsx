            ...
            {filteredOrders.map((order) => (
              ...
              <div className="flex items-start justify-between mb-3 gap-2">
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-bold text-gray-900 truncate mb-1">Order #{order.id}</h3>
                  ...
                  {order.prNumber && (
                    <p className="text-xs text-blue-600 truncate font-medium">PR: {order.prNumber}</p>
                  )}
                  {order.poNumbers && order.poNumbers.length > 0 && (
                    <p className="text-xs text-green-600 truncate font-medium">PO: {order.poNumbers.join(', ')}</p>
                  )}
                </div>
