...
import PickupManagement from '@/components/shipment/PickupManagement'
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Pickup Management Section (ADD-ON - Only for API shipments with AWB) */}
            {shipment && shipment.shipmentId && (
              <PickupManagement
                shipmentId={shipment.shipmentId}
                shipmentMode={shipment.shipmentMode || 'MANUAL'}
