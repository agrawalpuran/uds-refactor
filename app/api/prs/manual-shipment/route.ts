    ...
    for (const prData of prs) {
      try {
        ...
        const shipmentData = {
          ...
          // CRITICAL: For manual shipments, store AWB/SWB number ONLY in providerShipmentReference
          // Do NOT store in trackingNumber or courierAwbNumber for manual shipments
